...
- [天才程序员的神话](https://www.youtube.com/watch?v=0SARbwvhupQ)， 不断学习 + 努力实践 + 沟通交流
- [不要单打独斗：面对技术中的隐形怪物](https://www.youtube.com/watch?v=1i8ylq4j_EY)， 学会合作，学会沟通，利用 github 等代码托管和其他人进行合作；利用FACEBOOK、Twitter等社交媒体进行交流；真实世界里的当面沟通。程序员要会写代码，同时要能用自然语言想他人展示自己的工作。
...
- [x] [ABC：不要停止编程（Always Be Coding）](https://medium.com/always-be-coding/abc-always-be-coding-d5f8051afce2#.4heg8zvm4), 常写代码;理解算法分析的基本概念;问题导向，熟悉常用算法的复杂度分析;做一些项目；不要模棱两可
- [x] [白板编程（Whiteboarding）](https://medium.com/@dpup/whiteboarding-4df873dbba2e#.hf6jn45g1)，注意沟通；平时编码时，
记住常用的关键词和库；深思后回答，有疑问的话提出问题；完成后检查一下；大致描述算法的思想，然后用实例进行算法的讲解；事先了解一下招聘公司。
- [x] [揭秘技术招聘](https://www.youtube.com/watch?v=N233T0epWTs) 日常注意项目实践和社交媒体推广，实际招聘时：招聘者屏幕，被面试者屏幕，在线平台，被面试者自我简介及其他，招聘方审视。
- [ ] 如何在科技四强企业中获得一份工作：
